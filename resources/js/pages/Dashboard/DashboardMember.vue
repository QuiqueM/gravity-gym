    ...
    <div class="flex flex-col gap-1">
      ...
      <div v-if="hasNextClass">
        <p class="flex items-baseline gap-1 text-white">
          <span class="text-white text-4xl font-black leading-tight tracking-[-0.033em]">{{ nextClass.class.title }}</span>
        </p>
      ...
      <div v-else class=" flex flex-col gap-3 justify-center mt-3">
        <span class="text-white text-base font-bold leading-tight">Aún no te has inscrito</span>
        <Button variant="secondary">Comienza ahora</Button>
      </div>
    </div>
