    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <div class="bg-background border border-primary py-8 px-4 shadow-lg shadow-primary sm:rounded-lg sm:px-10">
        ...
        <div class="text-center">
          ...
          <h1 class="text-2xl font-bold text-primary mb-2">¡Pago Exitoso!</h1>
          <p class="text-muted-foreground mb-6">Tu membresía ha sido activada correctamente</p>
          ...
          <div class="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <div class="text-sm text-gray-600 space-y-1">
              ...
              <p>Estado: <span class="text-green-600 font-medium">Aprobado</span></p>
            </div>
          </div>
          ...
          <div class="mt-6 text-xs text-muted-foreground">
            ...
            <p>• Tu membresía está activa desde ahora</p>
            <p>• Puedes acceder a todas las clases disponibles</p>
          </div>
        </div>
      </div>
    </div>
